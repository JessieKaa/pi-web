...
const EXPECTED_ROUTES = {
  ...
  "app/api/cache-warming/route.ts": ["GET", "PUT"],
  ...
  "app/api/image-resize/route.ts": ["GET", "PUT"],
  ...
  "app/api/models/scope/route.ts": ["GET", "POST", "PUT"],
  ...
  "app/api/title-generation-settings/route.ts": ["GET", "PUT"],
...
const EXPECTED_ADAPTERS = {
  ...
  "src/routes/api/cache-warming.ts": { route: "/api/cache-warming", methods: ["GET", "PUT"] },
  ...
  "src/routes/api/image-resize.ts": { route: "/api/image-resize", methods: ["GET", "PUT"] },
  ...
  "src/routes/api/models/scope.ts": { route: "/api/models/scope", methods: ["GET", "POST", "PUT"] },
  ...
  "src/routes/api/title-generation-settings.ts": { route: "/api/title-generation-settings", methods: ["GET", "PUT"] },
...
test("every API handler has a thin TanStack adapter with the expected route and methods", async () => {
  assert.equal(Object.keys(EXPECTED_ADAPTERS).length, 51);
...
test("the internal API inventory contains exactly the expected 51 routes", async () => {
