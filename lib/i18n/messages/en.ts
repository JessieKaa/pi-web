...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.titleGeneration": "Session title generation",
    "settings.titleGenerationDescription": "Choose which model names sessions, or follow the model already in use.",
    "settings.titleGenerationProvider": "Provider",
    "settings.titleGenerationModel": "Model",
    "settings.titleGenerationThinking": "Thinking level",
    "settings.titleGenerationFollowSession": "Follow the current session model",
    "settings.titleGenerationFollowing": "Following the current session model.",
    "settings.titleGenerationUnavailable": "The saved title model is not available in this project. Choose a model to update it.",
    "settings.titleGenerationProjectRequired": "Select a project to choose a title model.",
    "settings.titleGenerationNoModels": "No models are available in this project.",
    "settings.titleGenerationRetry": "Retry",
    ...
    "settings.modelScope": "Model list",
    "settings.modelScopeDescription": "Choose which models appear in the picker. Open sessions keep the previous list until they reload.",
    "settings.modelScopeReadOnly": "This project overrides the model list. Edit the project settings file to change it.",
    "settings.modelScopeRefresh": "Refresh catalog",
    "settings.modelScopeRefreshing": "Refreshing…",
    "settings.modelScopeFilter": "Filter models",
    "settings.modelScopeEmpty": "No models",
    "settings.modelScopeKeepOne": "Keep at least one model enabled.",
    ...
    "chat.thinkingSegment": "thinking block",
    "chat.thinkingSegments": "thinking blocks",
    "chat.collapseThinking": "Collapse thinking",
    "chat.expandThinking": "Expand thinking",
    ...
    "chat.presetConfigured": "Configured",
    ...
    "chat.presetConfiguredHint": "Pi's configured tools, until you pick a preset",
    ...
    "chat.commandAutoCompact": "Turn automatic context compression on or off",
    ...
    "models.imageResize": "Image resize",
    "models.imageResizeHelp": "Cache-safe limits applied before a new image is sent. Blank keeps the provider default.",
    "models.imageResizeSummary": "Image resize: {count}",
    "models.imageMaxWidth": "Max width",
    "models.imageMaxHeight": "Max height",
    "models.imageMaxBytes": "Max bytes",
    "models.imageJpegQuality": "JPEG quality",
