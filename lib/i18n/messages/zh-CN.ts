...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.cacheWarming": "缓存预热",
    "settings.cacheWarmingDescription": "pi 会重发对话以保持 prompt 缓存热度，降低每轮输入成本。",
    "settings.cacheWarmingOff": "关闭",
    "settings.cacheWarmingStreaming": "流式输出时",
    "settings.cacheWarmingIdle": "流式输出和空闲时",
    "settings.titleGeneration": "会话标题生成",
    "settings.titleGenerationDescription": "选择用于命名会话的模型，或跟随当前会话已使用的模型。",
    "settings.titleGenerationProvider": "提供方",
    "settings.titleGenerationModel": "模型",
    "settings.titleGenerationThinking": "思考等级",
    "settings.titleGenerationFollowSession": "跟随当前会话模型",
    "settings.titleGenerationFollowing": "正在跟随当前会话模型。",
    "settings.titleGenerationUnavailable": "已保存的标题模型在当前项目中不可用。请选择模型以更新。",
    "settings.titleGenerationProjectRequired": "请先选择项目，再选择标题模型。",
    "settings.titleGenerationNoModels": "当前项目没有可用模型。",
    "settings.titleGenerationRetry": "重试",
    "settings.imageAutoResize": "缩放图片",
    "settings.imageAutoResizeDescription": "图片进入模型上下文前先缩小。对话里仍保留原图。正在进行的会话要到下次开始才会改读取设置。项目设置会盖过这个开关。",
    "settings.modelScope": "模型列表",
    "settings.modelScopeDescription": "选择选择器里出现哪些模型。已经打开的会话要重新加载后才换新列表。",
    "settings.modelScopeReadOnly": "当前项目覆盖了模型列表。要改的话，编辑项目设置文件。",
    "settings.modelScopeRefresh": "刷新目录",
    "settings.modelScopeRefreshing": "正在刷新…",
    "settings.modelScopeFilter": "筛选模型",
    "settings.modelScopeEmpty": "没有模型",
    "settings.modelScopeKeepOne": "至少保留一个启用的模型。",
    "settings.about": "关于",
    ...
    "chat.thinkingSegment": "段思考",
    "chat.thinkingSegments": "段思考",
    "chat.collapseThinking": "收起思考",
    "chat.expandThinking": "展开思考",
    ...
    "chat.presetConfiguredHint": "使用 Pi 配置里的工具，直到你手动选预设",
    ...
    "chat.commandAutoCompact": "打开或关闭自动压缩上下文",
    ...
    "models.imageResize": "图片缩放",
    "models.imageResizeHelp": "新图片发送前使用的缓存安全限制。留空则沿用 Provider 默认值。",
    "models.imageResizeSummary": "图片缩放：{count}",
    "models.imageMaxWidth": "最大宽度",
    "models.imageMaxHeight": "最大高度",
    "models.imageMaxBytes": "最大字节",
    "models.imageJpegQuality": "JPEG 质量",
