...
test("groups recent sessions under project folders and promotes pinned folders", () => {
  ...
  ], [{ ...projects[0], pinned: true }, projects[1]], new Set());
...
test("pinned projects remain visible after falling outside the regular recency cap", () => {
  const groups = buildRecentProjectGroups([
